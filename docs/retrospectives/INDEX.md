...
| ID | 날짜 | plan | 제목 | 상태 | 승격 |
| --- | --- | --- | --- | --- | --- |
| RETRO-0001 | 2026-07-30 | plan002-pipeline-config | 전역 설정 이관이 명령 경계를 넓혔다 | 해결 | 승격 안 함 |
| RETRO-0002 | 2026-07-30 | plan002-pipeline-config | 관리 문서가 현재 구현과 목표 설계를 섞었다 | 해결 | 승격 안 함 |
